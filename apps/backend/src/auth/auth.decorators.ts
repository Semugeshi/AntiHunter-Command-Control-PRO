...
export const ALLOW_TWO_FACTOR_PENDING_KEY = Symbol('allowTwoFactorPending');
...
export const AllowTwoFactorPending = () => SetMetadata(ALLOW_TWO_FACTOR_PENDING_KEY, true);
